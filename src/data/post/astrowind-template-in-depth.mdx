...
title: MedSyntra template in depth
excerpt: While easy to get started, MedSyntra is quite complex internally.  This page provides documentation on some of the more intricate parts.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://MedSyntra.vercel.app/MedSyntra-template-in-depth
---
